            ...
            <div className=" w-[90%] md:w-4/5 md:flex-row mt-24 mb-24">
                ...
                <div className=" flex flex-col-reverse justify-between md:flex-row ">
                    <div className="w-full md:w-[45%]">
                        ...
                        I am a seasoned front-end developer who uses software programming tools to create and maintain functional and interactive, user-friendly Web interfaces. Beyond just writing codes, I strive to <span className="font-bold">innovate solutions</span> to real-life problems and make the world a better place through software development. I have <span className="font-bold">4+ years</span> of experience in software development, and in this short time of my career, I have had the privilege of collaborating with designers, co-developers, and experts across diverse fields to develop products that serve users effectively as well as align with business objectives. I have also single-handedly developed some projects from scratch to finish. This shows not just the engagement of my hard tech skills but also soft skills like self-discipline to achieve goals even when unsupervised. Knowing that the tech industry is rapidly growing, I read extensively and do research daily to keep myself up to date with current trends in software development.
                        </p>
